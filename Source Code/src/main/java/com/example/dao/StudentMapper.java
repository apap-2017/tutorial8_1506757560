...
public interface StudentMapper
{
    ...
    List<StudentModel> selectStudentsTakeCourses(@Param ("id") String id);
    ...
    @Results(value = {
    		...
    		@Result(property="students", column="id_course",
    			javaType = List.class,
    			many=@Many(select="selectStudentsTakeCourses"))
	})
    CourseModel selectCourseInfo (@Param("id")String id);
    ...
    List<CourseModel> selectAllCoursesInfo();
}
